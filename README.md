...
There are now two PCB decoder boards, the Original version as above with decoder and MP3 player and a new mini-version that is about 1x3in that just contains the decoder and ESP32 processor that can be embedded inside the wall box.
